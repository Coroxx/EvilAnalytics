        ...
        <div class="container flex flex-wrap items-center w-full pt-3 mx-auto mt-0">
            ...
            <div class="w-full pl-3 text-center md:pl-0">
                <a class="text-base font-bold no-underline md:text-2xl hover:no-underline" href="#">
                    <img src="https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/apple/285/vampire_light-skin-tone_1f9db-1f3fb_1f3fb.png"
                        alt="icon" class="inline w-6 h-6 -mt-2 md:-mt-3 md:w-8 md:h-8">
            ...
            <div id="lang" class="w-full text-center md:w-auto md:absolute md:text-left md:m-0 top-4 right-4">
                <div>
                    <a href="{{ route('analytics', 'en') }}">
                        <img src="https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/apple/285/flag-united-kingdom_1f1ec-1f1e7.png"
                            class="inline w-6 h-6" alt="emoji_ang">
                    </a>
                    <a href="{{ route('analytics', 'fr') }}"> <img
                            src="https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/apple/285/flag-france_1f1eb-1f1f7.png"
                    ...
                    <li class="w-24 my-2 mr-6 md:my-0">
                        <a href="#"
                            ...
                            <i class="mr-3 text-red-500 fas fa-home fa-fw"></i><span
                                class="pb-1 text-sm md:pb-0">{{ __('evilanalytics::dashboard.home') }}</span>
                        </a>
                    </li>
                </ul>
            </div>
                    ...
                    <div class="p-2 rounded shadow bg-main">
                        <div class="flex flex-row items-center">
                            ...
                            <div class="flex-1 text-right md:text-center">
                                <h5 class="font-bold text-red-500 uppercase">
                                    {{ __('evilanalytics::dashboard.today_requests') }}</h5>
                ...
                <div class="w-full p-3 md:w-1/2 xl:w-1/3">
                    ...
                    <div class="p-2 rounded shadow bg-main">
                        <div class="flex flex-row items-center">
                            ...
                            <div class="flex-1 text-right md:text-center">
                                <h5 class="font-bold text-red-500 uppercase">
                                    {{ __('evilanalytics::dashboard.today_users') }}</h5>
                ...
                <div class="w-full p-3 md:w-1/2 xl:w-1/3">
                    ...
                    <div class="p-2 rounded shadow bg-main">
                        <div class="flex flex-row items-center">
                            ...
                            <div class="flex-1 text-right md:text-center">
                                <h5 class="font-bold text-red-500 uppercase">
                                    {{ __('evilanalytics::dashboard.week_device') }}</h5>
                ...
                <div class="w-full p-3 md:w-1/2 xl:w-1/3">
                    ...
                    <div class="p-2 rounded shadow bg-main">
                        <div class="flex flex-row items-center">
                            ...
                            <div class="flex-1 text-right md:text-center">
                                <h5 class="font-bold text-red-500 uppercase">
                                    {{ __('evilanalytics::dashboard.month_users') }}</h5>
            ...
            <div class="flex flex-row flex-wrap flex-grow mt-2">
                    ...
                    <div class="border border-gray-800 rounded shadow bg-main">
                        <div class="p-3 border-b border-gray-800">
                            <h5 class="font-extrabold uppercase" style="color: #4bc0c0">
                                {{ __('evilanalytics::dashboard.uniques_visitors_requests') }}</h5>
                        </div>
                        <div class="p-5 h-80">
                                ...
                                new Chart(document.getElementById("chartjs-7"), {
                                    ...
                                    "data": {
                                        "labels": ["{{ now()->subDays(3)->format('d/m') }}", "{{ now()->subDays(2)->format('d/m') }}",
                                            "{{ __('evilanalytics::dashboard.yesterday') }}",
                                            "{{ __('evilanalytics::dashboard.today') }}"
                                        ],
                                        "datasets": [{

                                                "label": "   {{ __('evilanalytics::dashboard.uniques_visitors') }}      ",
                                                "data": [
                ...
                <div class="w-full p-3 md:w-1/2">
                    ...
                    <div class="border border-gray-800 rounded shadow bg-main">
                        <div class="p-3 border-b border-gray-800">
                            <h5 class="font-extrabold uppercase" style="color: #4bc0c0">
                                {{ __('evilanalytics::dashboard.most_used_routes') }}
                            </h5>
                        </div>
                        <div class="p-5 h-80">
                    ...
                    <div class="border border-gray-800 rounded shadow bg-main">
                        <div class="p-3 border-b border-gray-800">
                            <h5 class="font-bold uppercase" style="color:#ff6384">
                                {{ __('evilanalytics::dashboard.most_used_devices') }}</h5>
                        </div>
                        <div class="p-5 h-80">
                ...
                <div class="w-full p-3 md:w-1/2 xl:w-2/3">
                    ...
                    <div class="border border-gray-800 rounded shadow bg-main">
                        <div class="p-3 border-b border-gray-800">
                            <h5 class="font-bold uppercase" style="color:#ff6384">
                                {{ __('evilanalytics::dashboard.most_present_countries') }}</h5>
                        </div>
                        <div class="p-5 h-80">
        ...
        <footer class="border-t border-gray-400 shadow bg-main">
            <div class="container flex max-w-md py-8 mx-auto">
                ...
                <div class="flex flex-wrap w-full mx-auto">
                    <div class="flex w-full md:w-1/2 ">
                        <div class="px-8">
                            ...
                            <p class="py-4 text-sm text-gray-600">
                                {{ __('evilanalytics::dashboard.footer_bio') }}
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex w-full md:w-1/2">
                        <div class="px-8">
                            <h3 class="font-bold text-gray-100">{{ __('evilanalytics::dashboard.footer_bio2') }}</h3>
                        </div>
                    </div>
                </div>
